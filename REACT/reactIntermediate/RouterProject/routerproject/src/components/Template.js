    ...
    return (
        <div className="flex w-11/12 max-w-[1160px] py-12 mx-auto gap-y-0 gap-x-12 justify-between">
            ...
            <div className="relative w-11/12 max-w-[450px]">
                <img src={frameImage} alt='Pattern' height={558} width={504} loading='lazy' />
                <img src={image} alt='Student' height={558} width={504} loading='lazy' className="absolute -top-4 right-4" />
            </div>
